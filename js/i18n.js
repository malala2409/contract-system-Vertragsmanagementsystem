...
const I18N = {
  de: {
    ...
    label_sections_json: 'Abschnitte (JSON-Format)',
    btn_create_template: 'Neue Vorlage erstellen (Assistent)',
    create_template_title: 'Neue Vertragsvorlage erstellen',
    ...
    field_key: 'Feldname',
    field_type: 'Typ',
    field_label_de: 'Label (DE)',
    field_label_en: 'Label (EN)',
    field_options: 'Optionen (durch Komma getrennt)',
    ...
    module_palette: 'Modul-Palette',
    drag_here: 'Module hierher ziehen',
  ...
  en: {
    ...
    label_sections_json: 'Sections (JSON format)',
    btn_create_template: 'Create New Template (Wizard)',
    create_template_title: 'Create New Contract Template',
    ...
    drag_here: 'Drag modules here',
    toc: 'Table of Contents',
  }
};

function t(key) {
  const lang = (typeof state !== 'undefined' && state && state.lang) ? state.lang : (function() {
    try { return localStorage.getItem('cm.lang') || 'de'; } catch(_) { return 'de'; }
  })();
...
function setLang(l) {
  ...
  try { localStorage.setItem('cm.lang', l); } catch(_) {}
  // Update lang toggle button styles
  var btnDE = document.getElementById('btnDE');
  var btnEN = document.getElementById('btnEN');
  if (btnDE) { btnDE.classList.toggle('font-bold', l === 'de'); btnDE.classList.toggle('underline', l === 'de'); }
  if (btnEN) { btnEN.classList.toggle('font-bold', l === 'en'); btnEN.classList.toggle('underline', l === 'en'); }
  render();
}
